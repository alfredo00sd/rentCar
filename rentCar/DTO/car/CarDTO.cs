...
namespace RentCarApp.DTO
{
    public class CarDTO
    {
        ...
        int _CarFabYear;
        string _CarChasisNum; //max 17
        string _CarEngineNum; //max 40
        string _CarLicensePlate; //max 15
        string _CarColor;//max 25
        int _CarNumberOfDoors;
        int _CarCapacityOfPassangers;
        string _CarConditions; //max 15
        int _CarUseInKM;// max 40
        ...
        public int CarBrandId { get => _CarBrandId; set => _CarBrandId = value; }
        [Required(AllowEmptyStrings = false, ErrorMessage = "Se requiere completar campo {0}")]
        [Display(Name = "Modelo del carro")]
        public int CarModelId { get => _CarModelId; set => _CarModelId = value; }
        [Display(Name = "Foto del carro")]
        public int CarBase64Photo { get => _CarBase64Photo; set => _CarBase64Photo = value; }
        public int CarStatus { get => _CarStatus; set => _CarStatus = value; }
        [Required(AllowEmptyStrings = false, ErrorMessage = "Se requiere completar campo {0}")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Ingresar un valor mayor que {1}, en el campo {0}")] 
        public int CarUseInKM { get => _CarUseInKM; set => _CarUseInKM = value; }
